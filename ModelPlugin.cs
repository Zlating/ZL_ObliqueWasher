...
namespace ZL_ObliqueWasher_pl
{
    ...
    public class ZL_ObliqueWasher_pl : PluginBase
    {
                        ...
                        foreach (Part p in parts)
                        {
                            if (p is Beam)
                            {
                                ...
                                foreach (Point pb in bg.BoltPositions)
                                {
                                    ...
                                    #region Óêëîí ïîëîê - òî÷êè ÷åðåç ñîëèä
                                    ...
                                    #region Òî÷êè äëÿ ïîñòðîåíèÿ ïëàñòèíû
        ...
        #region Ïåðåñå÷åíèå ñîëèäà ãåîìåòðè÷åñêîé ïëîñêîñòüþ
        /// <summary>
        /// Ïåðåñå÷åíèå ñîëèäà ãåîìåòðè÷åñêîé ïëîñêîñòüþ
        /// </summary>
        /// <param name="solid">Ñîëèä</param>
        /// <param name="plane">Ãåîìåòðè÷åñêàÿ ïëîñêîñòü</param>
        /// <returns>Êîëëåêöèÿ ïîëèãîíîâ(êîëëåêöèé òî÷åê)</returns>
