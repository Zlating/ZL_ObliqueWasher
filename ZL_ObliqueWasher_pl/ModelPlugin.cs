...
namespace ZL_ObliqueWasher_pl
{
    public class PluginData
    {
        ...
        [StructuresField("us_prop_weight")]
        public string us_prop_weight;
        [StructuresField("weight")]
    ...
    public class ZL_ObliqueWasher_pl : PluginBase
    {
        ...
        void GetValuesFromDialog()
        {
            ...
            if (!IsDefaultValue(Data.us_prop_weight)) us_prop_weight = Data.us_prop_weight;
            if (!IsDefaultValue(Data.weight)) weight = Data.weight;
        }
